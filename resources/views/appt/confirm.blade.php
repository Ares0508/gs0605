                ...
                <div class="table-responsive mb-2">
                    ...
                    <p class="px-3 font-weight-bold" style="border-left: 5px solid #28A745;">ご依頼内容</p>
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" onclick="location.href='/appointment/create2/{{$appoint['id']}}'" class="btn btn-outline-success mr-1">
                            日程調整へ戻る
                            </button>
                            <input class="btn btn-success px-5" value="送信" type="submit" onclick="location.href='/appointment/done'">
                            <div class="px-5"></div>
                        </div>
                        <!-- END-navigation -->
